...
export const PRESETS: Preset[] = [
  {
    ...
    pages: [
      [
        { prompt: '今日最重要的科技新闻头条，突出事件本身与影响，200 字', kind: 'text', x: 15, y: 15, width: 180, height: 55 },
  ...
  },
  {
    ...
    pages: [
      [
        ...
        { prompt: '一则值得关注的财经大事深度解读，250 字', kind: 'text', x: 15, y: 170, width: 180, height: 110 }
      ]
    ]
  },
  {
    ...
    pages: [
      [
        ...
        { prompt: '记录一件本周值得记住的事，带一点感性表达，150 字', kind: 'text', x: 15, y: 190, width: 180, height: 90 }
      ]
    ]
  }
]
